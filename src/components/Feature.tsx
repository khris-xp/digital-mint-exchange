        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-32">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                ...
                <p className="text-base text-gray-700 md:text-lg">
                    Digital Mint Exchange infrastructure is designed to have maximum security without compromising on agility, flexibility, and control
                </p>
            </div>
            <div className="grid gap-8 row-gap-10 lg:grid-cols-2">
                <div className="max-w-md sm:mx-auto sm:text-center">
                    ...
                    <a
                        href="/"
                        aria-label=""
                        className="inline-flex items-center font-semibold transition-colors duration-200 text-blue-500 hover:text-deep-purple-800"
                    >
                        Learn more
                    </a>
                </div>
